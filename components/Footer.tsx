			...
			<Layout>
				<div className="grid grid-cols-1 p-4 sm:grid-cols-3 lg:grid-cols-4 place-items-center sm:place-items-start grid-col">
					<div className=" sm:col-span-1 lg:col-span-2">
						...
						Evoke is where memories come alive, encouraging us to revisit, reflect, and evolve.
						</p>
						...
						<ul className="my-4">
							<li className="w-fit bg-gray-300 rounded-lg hover:cursor-pointer hover:bg-black transition-colors duration-200 ease-in-out p-2">
								<a href="https://www.instagram.com/saaadi_2.0/" target="_blank">
								<svg
					...
					<div className="p-3">
						...
						<a href="mailto:saaadi.work@gmail.com" className="flex space-x-1">
							<svg
								xmlns="http://www.w3.org/2000/svg"
								fill="none"
								viewBox="0 0 24 24"
