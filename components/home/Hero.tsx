						...
						<div className=" grid grid-cols-1 sm:grid-cols-2 place-items-stretch sm:space-x-10 ">
							...
							<div className="sm:w-3/4" data-aos="fade-left">
								...
								<p className=" line-clamp-4 text-base sm:text-lg md:text-xl space-y-8">
									...
									Porro, tempora explicabo. Eum eveniet at doloremque dolor amet
									rem dolorem velit! Lorem ipsum dolor sit amet consectetur
									adipisicing elit. Mollitia earum repellat sit, sapiente
									veritatis vel a quasi cumque fugiat doloribus voluptatum
									pariatur nisi at reiciendis itaque quaerat fuga asperiores
									labore.
								</p>
								<a
									href=""
